    ...
    <div class="container">
        ...
        <div class="preview-container" id="preview-container">
            <div class="payslip-header">
                <img src="ATS_Wallpaper.jpg" alt="ATS Logo" class="company-logo" style="width: 180px; height: 100px; border-radius: 10px; object-fit: contain; background-color: #f9f9f9;" onerror="this.src='https://placehold.co/180x100?text=Logo'" />
            ...
            <div class="payslip-details">
                <div class="detail-col">
                    ...
                    <div class="detail-item">
                        ...
                        <span id="preview-provident-fund"></span>
                    </div>
                </div>
                <div class="detail-col">
                    <div class="detail-item">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function savePayslip() {
                if (validateForm()) {
                    ...
                    try {
                        const response = await fetch('http://98.80.67.100:3018/api/payslips', {
                            method: 'POST',
            ...
            async function loadPayslips() {
                try {
                    const response = await fetch('http://98.80.67.100:3018/api/payslips/all');
                    if (!response.ok) {
            ...
            async function deletePayslip(id) {
                try {
                    const response = await fetch(`http://98.80.67.100:3018/api/payslips/${id}`, {
                        method: 'DELETE'
                    });
                    if (!response.ok) {
